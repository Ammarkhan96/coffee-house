...
function Reservation() {
  ...
  return (
    <form className="reservation-form" onSubmit={handleSubmit}>
      {success && (
        <p
          style={{ backgroundColor: "#212121", padding: "0.5rem 0", textAlign: "center",color: "white",}}
        >
      ...
      <div>
        <input type="text" name="first" id="first" placeholder="First Name" onChange={handleChange}
          required />
        <input type="text" name="last" id="last" placeholder="Last Name" onChange={handleChange}
          required />
      </div>
      ...
      <button type="submit" disabled={btnValidation}>Submit</button>
    </form>
  );
}
